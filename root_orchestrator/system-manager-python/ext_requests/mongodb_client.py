...
def mongo_init(flask_app):
    global app, mongo_clusters, mongo_jobs, mongo_users, mongo_applications, mongo_services, mongo_organization, mongo_gateway, mongo_gateway_nodes, mongo_gateway_services
    ...
    mongo_gateway = PyMongo(app, uri=MONGO_ADDR_GATEWAYS)
